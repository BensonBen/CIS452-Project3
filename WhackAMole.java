...
public class WhackAMole implements ActionListener {
    ...
    private static void promptUserInput() {
        ...
        // Set up the spinners
        // ------------------------------------------------------
        SpinnerModel           modelTimer  = new SpinnerNumberModel(count, 5, 100, 1);
        ...
        SpinnerModel numMoles      = new SpinnerNumberModel(WhackAMole.numMoles, 0, Integer.MAX_VALUE, 1);
        ...
        SpinnerModel boardIncrementer        = new SpinnerNumberModel(WhackAMole.sizeOfGame, 0, 10, 1);
        ...
        newGameFrame.addWindowListener(new WindowAdapter() {
                                           ...
                                           public void windowClosed(WindowEvent e) {
                                               ...
                                               if (numberOfMoles > (size * size)) {
                                                   JOptionPane.showMessageDialog(newGameFrame,
                                                                                 "decrease number of moles");
                                               } else {
